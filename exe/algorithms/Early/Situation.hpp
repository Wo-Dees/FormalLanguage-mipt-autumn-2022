...
class Situation {
 public:
  Situation(const exe::grammar::CFRule& rule, size_t index_low_dot_,
            size_t index_high_dot_ /*, size_t who_i*/);
  Situation(const Situation& situation,
            size_t index_low_dot_ /*, size_t who_i */);
